    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white p-4">
        <h1 className="text-4xl md:text-6xl font-bold mb-8">
          ¿Para quién es <span className="text-amber-400">NOT A GAME</span>?
        </h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full">
          <div className="bg-gray-800 bg-opacity-75 p-6 rounded-lg">
            <p className="text-xl font-semibold mb-4">
            <span className="text-amber-400">NOT A GAME</span> es un proceso de transformación del aprendizaje que puede ser usado por: 
            </p>
        ...
        <div className="bg-gray-800 bg-opacity-75 p-6 rounded-lg">
            <p className="text-xl font-semibold mb-4">
              <span className="text-amber-400">NOT A GAME</span> está diseñado como una herramienta de gamificación que permite abordar dinámicas como:
            </p>
            <ul className="space-y-3">
